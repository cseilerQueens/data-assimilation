...
# dir <-"/home/cseiler/projects/def-cseiler-ab/cseiler/data-assimilation/analysis/ALBS-GPP-HFLS-HFSS-LAI-TS-PAR28-GC80-P100-I1901-old"

  myFile <- file.path(dir, "object_iteration_24.rds")
