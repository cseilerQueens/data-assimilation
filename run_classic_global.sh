...
# simulation ID
simulationID=transient_CRUJRAv2.4.5_opt
...
outputDir="/home/cseiler/projects/def-cseiler-ab/cseiler/data-assimilation/simulations/$simulationID"

# Path of CLASSIC executable
sourceCodeDir="/home/cseiler/classic/classic_code/classic"

# email
email=christian.seiler@queensu.ca

# xmlFile='/home/cseiler/classic/classic_code/classic/configurationFiles/outputVariableDescriptors_daisy.xml'
xmlFile='/home/cseiler/classic/classic_code/classic/configurationFiles/outputVariableDescriptors.xml'
...
lnduseon=.true.
transientLGHT=.true.
readMetStartYear=1701 # 2001-2010 for tuning
...
cd $outputDir
/home/cseiler/classic/classic_code/classic/bin/CLASSIC_parallel_intel job_options.txt $lon/$lat
touch /home/cseiler/projects/def-cseiler-ab/cseiler/data-assimilation/simulations/classicFinished" >> classic_submit_gridCell.sh
